...
def split_train_validation(feature_stack_train, label_stack_train):
    ...
    return feature_stack_train, label_stack_train, feature_stack_validation, label_stack_validation


class HDD_Dataset:
    def __init__(self, n_mini_batch, data_path='../datasets/hdd/', epsilon=1e-10):
        ...
        self.feature_stack_train, self.label_stack_train, self.feature_stack_validation, self.label_stack_validation = \
    ...
    def get_next_training_batch(self):
        features, labels, seq_len = self.load_features('train',
    ...
    def get_validation_batch(self):
        return self.load_features('validation', np.arange(self.n_validation, dtype=np.int))
